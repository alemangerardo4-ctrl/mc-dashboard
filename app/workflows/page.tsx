  ...
  const workflows = [
    {
      ...
      steps: [
        { label: 'Generate Figma PAT',              done: true,  owner: 'Gerardo' },
        { label: 'Install figma-developer-mcp v0.6.4', done: true,  owner: 'Winston' },
        { label: 'start.sh + test.sh + .env scaffold', done: true,  owner: 'Winston' },
        { label: 'Store PAT in .env',                        done: true,  owner: 'Gerardo' },
        { label: 'Create Figma file — Public Works Design System', done: true, owner: 'Gerardo' },
        { label: 'Run test.sh — PAT + file verified',         done: true,  owner: 'Winston' },
        { label: 'MCP server session + tool calls confirmed', done: true,  owner: 'Winston' },
        { label: 'Extract tokens (rate limit cleared)',        done: false, owner: 'Winston' },
        { label: 'Apply tokens to Tailwind config',           done: false, owner: 'Winston' },
        { label: 'Wire to MC + automate on heartbeat',        done: false, owner: 'Winston' },
      ],
      playbook: '/integrations/figma/PLAYBOOK.md',
      blocker: 'Add color/text styles to Figma file to populate tokens',
    },
    {
