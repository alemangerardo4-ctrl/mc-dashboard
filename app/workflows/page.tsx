  ...
  const workflows = [
    {
      ...
      steps: [
        ...
        { label: 'Store PAT in .env',               done: false, owner: 'Gerardo' },
        { label: 'Create Figma design file',         done: false, owner: 'Gerardo' },
        { label: 'Run test.sh — verify connection',  done: false, owner: 'Winston' },
      ...
      blocker: 'Waiting on: PAT in .env + Figma file URL from Gerardo',
    },
    {
